...
class EditScreen extends StatefulWidget {
  ...
  EditScreen({Key? key, this.snapshot});
  @override
...
class _EditScreenState extends State<EditScreen> {
  ...
  setData() {
    if (widget.snapshot!['carType'] == 'bigCar') {
      selectedCarIndex = 1;
      carType = 'bigCar';
    } else if (widget.snapshot!['carType'] == 'smallCar') {
      selectedCarIndex = 2;
      carType = 'smallCar';
    } else {
      selectedCarIndex = 0;
    ...
    carCategory = widget.snapshot!['category'];
    colorController.text = widget.snapshot!['color'];
    digitController.text = widget.snapshot!['digits'];
    alphabetController.text = widget.snapshot!['alphabets'];
    controller.minicat = widget.snapshot!['subcategory'];
  }
